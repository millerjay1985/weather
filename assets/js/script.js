    ...
    function locationSuccess(position) {
        ...
        try{
            ...
            if(cache && cache.timestamp && cache.timestamp > d.getTime() - 30*60*1000){
                ...
                var weatherAPI = 'http://api.openweathermap.org/data/2.5/forecast?lat='+position.coords.latitude+'&lon='+position.coords.longitude+'&callback=?&appid=d764b67a93d8cc2654e70be7d6800994';
